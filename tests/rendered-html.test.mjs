...
test("server-renders the CRM Solutions service page", async () => {
  ...
  assert.match(
    html,
    /class="service-journey__skip" href="#crm-solutions-cta" data-scroll-direct="true" data-scroll-duration="2.8" data-scroll-ease="sine.inOut" data-scroll-preserve-view="true" data-service-skip="true"[^>]*>[\s\S]*?pixel-x[\s\S]*?Skip[\s\S]*?<\/a>/,
  );
